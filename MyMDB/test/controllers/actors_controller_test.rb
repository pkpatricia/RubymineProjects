...
class ActorsControllerTest < ActionController::TestCase
  ...
  test "should create actor" do
    assert_difference('Actor.count') do
      post :create, actor: { birthdate: @actor.birthdate, first_name: @actor.first_name, last_name: @actor.last_name }
    end
  ...
  test "should update actor" do
    patch :update, id: @actor, actor: { birthdate: @actor.birthdate, first_name: @actor.first_name, last_name: @actor.last_name }
    assert_redirected_to actor_path(assigns(:actor))
  end
